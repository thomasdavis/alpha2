...
**The present authorization remains documentation/research only.** Do not implement the ledger, call models to
generate corpus rows, train, provision RunPod, mutate live Donto, publish a new artifact, or post to Discord
without a later explicit bounded authorization citing the relevant PRD-09 stage.
