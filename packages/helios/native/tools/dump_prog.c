...
int main(void) {
  hp_word p[] = {
      ...
      hp_sts(7, 2, 0, hp_ctrl_safe()),
      hp_lds(5, 7, 0x80, hp_ctrl_setbar(0)),
      hp_isetp_gt_imm(0, 7, 0x1f, hp_ctrl_safe()),
      hp_isetp_gt_imm(1, 7, 0xf, hp_ctrl_safe()),
      hp_predicated(hp_lds(0, 7, 0, hp_ctrl_setbar(0)), 0, 1),
      hp_predicated(hp_sts(7, 0, 0, hp_ctrl_safe()), 1, 0),
