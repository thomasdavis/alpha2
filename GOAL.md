...
- **Pretrain**: 1B tokens minimum (17 tokens/param — demo-grade but honest; stretch 2-3B if G2 lands
  ...
  **LR SWEEP LIVE 2026-07-23:** functional/source commit `e6d9430` rebuilt 19/19 on the RTX 3090 pod
  ...
  pinned source/data/tokenizer contract. Through its step-4,000 checkpoint gate all rows are consecutive
  and finite, train/held-out loss is 3.8979/3.9035, median post-step-100 throughput is 3,840 tok/s,
  and all 41 allocator samples report exactly 34 slabs with zero overflow. The remote/mounted
  4,000-row prefix is byte-identical at `9a2df5eb…`; checkpoint 4,000 is a hash-mirrored,
  ...
  step 4,050 at 3,899 tok/s. Post-save telemetry stayed bounded at 4,028MB
  ...
  result is 0.1095 worse than `1e-3`, an interim signal.
