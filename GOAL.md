...
- **Pretrain**: 1B tokens minimum (17 tokens/param — demo-grade but honest; stretch 2-3B if G2 lands
  ...
  **LR SWEEP LIVE 2026-07-23:** functional/source commit `e6d9430` rebuilt 19/19 on the RTX 3090 pod
  ...
  candidate is live on the identical pinned contract. Through step 2,500 all rows are consecutive/finite;
  ...
  `926d7ff1…`; checkpoint 2,000 remains hash-mirrored/native-audited at `22f1d2ed…`. At the aligned
  gate it trails `2e-3` by 0.5673 and `1e-3` by 0.6900 held-out loss; training resumed through step
  2,550 at 3,936 tok/s. It remains under its
