...
- **Pretrain**: 1B tokens minimum (17 tokens/param — demo-grade but honest; stretch 2-3B if G2 lands
  ...
  **LR SWEEP LIVE 2026-07-23:** functional/source commit `e6d9430` rebuilt 19/19 on the RTX 3090 pod
  ...
  candidate is live on the identical pinned contract. Through step 500 all rows are consecutive/finite;
  ...
  `2fac8554…`; training resumed through step 550 at 3,846 tok/s with zero swap under its 60-second/1,800-second
