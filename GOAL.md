...
- **Pretrain**: 1B tokens minimum (17 tokens/param — demo-grade but honest; stretch 2-3B if G2 lands
  ...
  **LR SWEEP LIVE 2026-07-23:** functional/source commit `e6d9430` rebuilt 19/19 on the RTX 3090 pod
  ...
  candidate is live on the identical pinned contract. Through checkpoint 1,000 all rows are consecutive/finite;
  train/held-out loss is 5.1371/5.1802, median post-step-100 throughput is 3,862 tok/s, and all 11
  allocator samples report 34 slabs with zero overflow. Remote/mounted metrics and the native-audited
  692,528,815-byte checkpoint are byte-identical at `bb07968f…` / `dacaac91…`; training resumed through
  step 1,050 at 3,927 tok/s with zero swap under its 60-second/1,800-second
