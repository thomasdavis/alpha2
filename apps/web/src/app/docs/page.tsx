import { MethodBadge, Endpoint, Required, SectionHeading, EndpointHeading, SubHeading, Pre, ParamTable, S, N, K, C } from "@alpha/ui";
...
export default function DocsPage() {
  return (
    <div className="mx-auto max-w-[780px]">
      <h1 className="mb-1 text-lg font-bold text-text-primary">Alpha API</h1>
