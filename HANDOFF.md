# HANDOFF — alpha2 revival, state as of 2026-07-24 ~01:19 UTC
...
- **Second contracted LR pilot (`2e-3`) is LIVE** at
  ...
  deliberately pinned `e6d9430` source/data/tokenizer contract. Through its step-4,500 held-out gate,
  all rows are consecutive/finite, train/held-out loss is 3.6362/3.8100, median post-step-100
  throughput is 3,840 tok/s, and all 46 allocator samples report exactly 34 slabs with zero overflow.
  The remote/mounted 4,500-row prefix is byte-identical at SHA-256 `df586b4a…`; checkpoint 4,000 remains
  a hash-mirrored/native-audited 692,528,815-byte ALPH file at `c728fc85…`, with all 57,688,576
  parameters finite/nonzero. The guard safely retained exactly 2,000/3,000/4,000 after verified pruning.
  Training resumed through step 4,550 at 3,909 tok/s. Post-save telemetry
  ...
  snapshot and will be NVIDIA-proven before flagship. At the aligned gate `2e-3` is 0.1083 held-out loss
...
- RunPod balance was **$58.212418982** at about 01:19 UTC; total account burn was $0.301/hr including
